<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:78:"/www/web/erp/public_html/public/../application/home/view/caigou/cgszwuliu.html";i:1514427688;s:68:"/www/web/erp/public_html/public/../application/home/view/layout.html";i:1514539775;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
...
function dosearch(){
    ...
    layui.use('table', function(){
        ...
        table.reload('orderTable', {
          url: '<?php echo url('Caigou/getZcOrder'); ?>'
...
function xiangqing(data){
  ...
  layui.use('table', function(){
    var table = layui.table;
$.ajax({
  url: "<?php echo url('Caigou/getFhXiangqing'); ?>",
  type: 'POST',
  data: {'zcid':data.zcid},
...
function xiangqingSub(zcid){
  ...
  layer.confirm('确认装车单号为：zc-'+zcid+'已成功装车?', {icon: 3, title:'警告'}, function(index){
      $.ajax({
        url: "<?php echo url('Caigou/completeSonghuo'); ?>",
        type: 'POST',
        data: {'zcid':zcid},
        success:function(res){
