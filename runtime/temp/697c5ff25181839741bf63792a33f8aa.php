<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:71:"/www/web/erp/public_html/public/../application/home/view/user/kehu.html";i:1514960184;s:68:"/www/web/erp/public_html/public/../application/home/view/layout.html";i:1514539775;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
...
layui.use('form', function(){
  ...
  form.on('submit(formEdit)', function(data){
    ...
    $.ajax({
      url: "<?php echo url('User/editKehu'); ?>",
      type: 'POST',
      data: data.field,
      success:function(res){
          layer.msg(res.msg, {time: 2000},function(){});
