<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:76:"/www/web/erp/public_html/public/../application/home/view/caigou/cgorder.html";i:1514427649;s:68:"/www/web/erp/public_html/public/../application/home/view/layout.html";i:1514539775;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
...
$("#editMsg input[name='price']").blur(function(){
  alert();
});
</script>
...
<style type="text/css">
    ...
    #dakuanMsg .layui-table-view .layui-table{width:100%;}
</style>
<div class="box">
  <p id="dakuanTitle"></p>
  <p id="dakuanTime"></p>
  <table class="dkTable" border="1" cellspacing="0">
      <tr>
          ...
          <th style="width:20%;"><input type="text" name="danhao" style="width:90%;height:100%;line-height:38px;border:0;" placeholder="请输入单号" id="dk_danhao"></th>
          <th style="width:10%;">打款方式</th>
          <th style="width:20%;"><input type="text" name="zkfs" style="width:90%;height:100%;line-height:38px;border:0;" placeholder="请输入打款方式" id="dk_zkfs"></th>
  ...
  <table class="dkTable" border="1" cellspacing="0">
      <tr>
          <th style="width:61%;"><input type="text" name="note" style="width:90%;height:100%;line-height:38px;border:0;" placeholder="请输入订单备注" id="dk_note"></th>
...
function dakuanSub(){
  ...
  // 判断是否填写了单号
  var zkfs = $("#dakuanMsg #dk_zkfs").val();
  if(zkfs.length==0){
    layer.msg("忘记填写打款方式啦！");
    return false;
  }
  ...
  layui.use('table', function(){
    ...
    if(checkStatus.data.length!=0){
      $.ajax({
        ...
        type: 'POST',
        data: {'shuju':checkStatus.data,'danhao':danhao,'zkfs':zkfs,'total':total,'note':note},
        success:function(res){
            layer.msg(res.msg, {time: 2000},function(){});
