<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:76:"/www/web/erp/public_html/public/../application/home/view/nansheng/daifa.html";i:1512726295;s:68:"/www/web/erp/public_html/public/../application/home/view/layout.html";i:1512891857;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
  ...
  form.on('radio(dcategory)', function(data){
    ...
    layui.use('table', function(){
        ...
        table.reload('orderTable', {
          url: '<?php echo url('Nansheng/getDfOrder'); ?>'
...
function xiangqing(data){
  layui.use('table', function(){
    ...
    //获取当前时间
$.ajax({
  url: "<?php echo url('Nansheng/getDfXiangqing'); ?>",
  type: 'POST',
  data: {'fhid':data.fhid},
...
function xiangqingSub(fhid){
  ...
  layer.confirm('这个单子我确认已经发货！', {icon: 3, title:'警告'}, function(index){
      $.ajax({
        url: "<?php echo url('Nansheng/completeDaifa'); ?>",
        type: 'POST',
        data: {'fhid':fhid},
        success:function(res){
