<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:76:"/www/web/erp/public_html/public/../application/home/view/sumao/shoukuan.html";i:1514427688;s:68:"/www/web/erp/public_html/public/../application/home/view/layout.html";i:1514539775;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
...
function dosearch(){
    ...
    layui.use('table', function(){
        ...
        table.reload('orderTable', {
          url: '<?php echo url('Sumao/getSkOrder'); ?>'
...
function xiangqingSub(fhid){
  ...
  layer.confirm('我确定客户已经收到货！', {icon: 3, title:'警告'}, function(index){
      $.ajax({
        url: "<?php echo url('Sumao/completeSk'); ?>",
        type: 'POST',
