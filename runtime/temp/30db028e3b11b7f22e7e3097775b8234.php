<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:78:"/www/web/erp/public_html/public/../application/home/view/caigou/cgntwuliu.html";i:1514427688;s:68:"/www/web/erp/public_html/public/../application/home/view/layout.html";i:1514539775;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
...
function dosearch(){
    ...
    layui.use('table', function(){
        ...
        table.reload('orderTable', {
          url: '<?php echo url('Caigou/getNtZcOrder'); ?>'
...
function xiangqing(data){
  ...
  layui.use('table', function(){
    var table = layui.table;
$.ajax({
  url: "<?php echo url('Caigou/getNtShXiangqing'); ?>",
  type: 'POST',
  data: {'zcid':data.zcid},
...
<div class="box">
  ...
  <div style="margin-top:15px;" class="xiangqingBtn">
    ...
    <button class="layui-btn layui-btn-warm xiangqingSub" cishu="0">完成</button>
  </div>
</div>
</div>
<script type="text/javascript">
...
function xiangqingSub(zcid){
  ...
  layer.confirm('确认单号为：zc-'+zcid+'已收货完成?', {icon: 3, title:'警告'}, function(index){
      $.ajax({
        url: "<?php echo url('Caigou/completeNtShouhuo'); ?>",
        type: 'POST',
        data: {'zcid':zcid},
        success:function(res){
