<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:78:"/www/web/erp/public_html/public/../application/home/view/nansheng/songhuo.html";i:1512800652;s:68:"/www/web/erp/public_html/public/../application/home/view/layout.html";i:1512891857;}*/ ?>
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
...
function dosearch(){
    ...
    layui.use('table', function(){
        ...
        table.reload('orderTable', {
          url: '<?php echo url('Nansheng/getZcOrder'); ?>'
...
function xiangqing(data){
  ...
  layui.use('table', function(){
    var table = layui.table;
$.ajax({
  url: "<?php echo url('Nansheng/getFhXiangqing'); ?>",
  type: 'POST',
  data: {'zcid':data.zcid},
...
function xiangqingSub(zcid){
  ...
  layer.confirm('确认装车单号为：zc-'+zcid+'已成功装车?', {icon: 3, title:'警告'}, function(index){
      $.ajax({
        url: "<?php echo url('Nansheng/completeSonghuo'); ?>",
        type: 'POST',
        data: {'zcid':zcid},
        success:function(res){
